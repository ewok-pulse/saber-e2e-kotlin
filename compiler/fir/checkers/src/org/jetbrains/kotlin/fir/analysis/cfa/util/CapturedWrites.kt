...
internal fun PathAwareControlFlowInfo<PropertyAccessType, VariableWriteData>.add(
...
internal fun PathAwareControlFlowInfo<PropertyAccessType, VariableWriteData>.overwrite(
    symbol: FirPropertySymbol,
