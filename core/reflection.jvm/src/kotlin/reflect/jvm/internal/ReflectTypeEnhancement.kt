...
internal class ReflectSignatureParts(
    ...
    override val containerDefaultTypeQualifiers: JavaTypeQualifiersByElementType?
        get() = ReflectAnnotationTypeQualifierResolver.extractAndMergeDefaultQualifiers(null, emptyList(), false)
    ...
    override fun getDefaultNullability(
        ...
        return defaultNullability?.takeIf { defaultTypeQualifiers.preferQualifierOverBound }
            ?: referencedParameterBoundsNullability?.takeIf { it.qualifier == NOT_NULL }
            ?: defaultNullability
    }
}
