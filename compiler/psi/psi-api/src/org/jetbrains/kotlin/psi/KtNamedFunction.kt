...
open class KtNamedFunction : KtTypeParameterListOwnerStub<KotlinFunctionStub>, KtFunction, KtDeclarationWithInitializer {
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().setFunctionTypeReference(this, typeRef) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().setFunctionTypeReference(this, typeRef)"),
    )
