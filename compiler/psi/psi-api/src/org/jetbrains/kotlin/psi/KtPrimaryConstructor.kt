...
class KtPrimaryConstructor : KtConstructor<KtPrimaryConstructor> {
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().removeRedundantConstructorKeywordAndSpace(this) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().removeRedundantConstructorKeywordAndSpace(this)"),
    )
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().addConstructorModifier(this, modifier) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().addConstructorModifier(this, modifier)"),
    )
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().removeConstructorModifier(this, modifier) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().removeConstructorModifier(this, modifier)"),
    )
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().addConstructorAnnotationEntry(this, annotationEntry) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().addConstructorAnnotationEntry(this, annotationEntry)"),
    )
