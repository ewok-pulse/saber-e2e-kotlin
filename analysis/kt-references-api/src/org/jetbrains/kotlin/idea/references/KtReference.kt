...
interface KtReference : PsiPolyVariantReference, KtResolvable {
     ...
     *    - If you have a companion object, and you use it implicitly via the class (e.g., [String] as an expression will be resolved to
     *      [String.Companion])
     *
     ...
     *
     * - `this`/`super` usages
     *    - [KtNameReferenceExpression] from [KtInstanceExpressionWithLabel] or `org.jetbrains.kotlin.idea.references.KDocReference` is
     *      context-sensitive and might be resolved to anonymous elements,
     ...
     *      so the result cannot be fully expressed in the terms of this API
     *
     * - `org.jetbrains.kotlin.idea.references.KtConstructorDelegationReference`
     *    - It resolves into constructors, but the result class name cannot be predicted properly since it might be generated
     *      by compiler plugins
     *
