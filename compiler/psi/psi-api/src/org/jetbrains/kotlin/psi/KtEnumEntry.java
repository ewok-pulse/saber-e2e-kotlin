...
public class KtEnumEntry extends KtClass implements KtDeclarationWithReturnType {
     ...
     * @deprecated Use {@code KtPsiMutatingService.getInstance().addSemicolon(this)} instead.
     */
    @KtExperimentalApi
    @NotNull
    @Deprecated
    public PsiElement addSemicolon() {
        return KtPsiMutatingService.getInstance().addSemicolon(this);
    }

    /**
     * @deprecated Use {@code KtPsiMutatingService.getInstance().deleteClassOrObject(this)} instead.
     */
    @Override
    @Deprecated
    public void delete() {
