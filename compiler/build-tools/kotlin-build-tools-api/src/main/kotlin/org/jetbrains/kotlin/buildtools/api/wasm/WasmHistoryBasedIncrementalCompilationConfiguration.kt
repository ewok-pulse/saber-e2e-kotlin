 ...
 *
 * Currently, the only supported implementation of this interface is [WasmHistoryBasedIncrementalCompilationConfiguration],
 * but more may be added in the future.
 *
 * @see WasmHistoryBasedIncrementalCompilationConfiguration
 * @since 2.4.20
 */
@ExperimentalBuildToolsApi
public interface WasmIncrementalCompilationConfiguration
 ...
 *
 * @see org.jetbrains.kotlin.buildtools.api.wasm.operations.WasmKlibCompilationOperation.Builder.historyBasedIcConfigurationBuilder
 * @since 2.4.20
 */
@ExperimentalBuildToolsApi
public interface WasmHistoryBasedIncrementalCompilationConfiguration : WasmIncrementalCompilationConfiguration,
    ...
    /**
     * A builder for [WasmHistoryBasedIncrementalCompilationConfiguration].
     *
     * @since 2.4.0
     */
    public interface Builder : BaseIncrementalCompilationConfiguration.Builder {
        ...
        /**
         * Creates an immutable instance of [WasmHistoryBasedIncrementalCompilationConfiguration] based on the configuration of this builder.
         *
         * @since 2.4.0
         */
        public fun build(): WasmHistoryBasedIncrementalCompilationConfiguration
    }

    /**
     * Creates a builder for [WasmHistoryBasedIncrementalCompilationConfiguration] that contains a copy of this configuration.
     *
     * @since 2.4.0
     */
    ...
    /**
     * An option for configuring a [WasmHistoryBasedIncrementalCompilationConfiguration].
     *
     * @see get
     * @see set
     */
    ...
    public companion object {
         ...
         *
         * The default value is to use [WasmHistoryBasedIncrementalCompilationConfiguration.workingDirectory] if not specified.
         *
