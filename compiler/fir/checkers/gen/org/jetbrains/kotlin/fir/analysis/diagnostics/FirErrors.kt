...
object FirErrors : KtDiagnosticsContainer() {
    ...
    val CV_DIAGNOSTIC: KtDiagnosticFactory1<String> = KtDiagnosticFactory1("CV_DIAGNOSTIC", WARNING, SourceElementPositioningStrategies.DEFAULT, KtElement::class, getRendererFactory())
