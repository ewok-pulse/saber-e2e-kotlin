...
// WITH_STDLIB
// LANGUAGE: -ValueClasses, +MultiPlatformProjects
...
<!UNSUPPORTED_FEATURE!>value<!> class Final1(val value1: String, val value2: String)
...
<!VALUE_CLASS_WITHOUT_JVM_INLINE_ANNOTATION!>value<!> class Final5<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>()<!>
expect <!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS!>value<!> class Final6
<!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS, VALUE_CLASS_WITHOUT_JVM_INLINE_ANNOTATION!>value<!> class Final7

@JvmInline
expect value class Final8<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>(val value1: String, val value2: String)<!>
@JvmInline
value class Final9<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>(val value1: String, val value2: String)<!>
@JvmInline
...
@JvmInline
value class Final13<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>()<!>
@JvmInline
expect <!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS!>value<!> class Final14
@JvmInline
<!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS!>value<!> class Final15
...
<!INLINE_CLASS_DEPRECATED!>inline<!> class Final17<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>(val value1: String, val value2: String)<!>
...
<!INLINE_CLASS_DEPRECATED!>inline<!> class Final21<!INLINE_CLASS_CONSTRUCTOR_WRONG_PARAMETERS_SIZE!>()<!>
expect <!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS, INLINE_CLASS_DEPRECATED!>inline<!> class Final22
<!ABSENCE_OF_PRIMARY_CONSTRUCTOR_FOR_VALUE_CLASS, INLINE_CLASS_DEPRECATED!>inline<!> class Final23
