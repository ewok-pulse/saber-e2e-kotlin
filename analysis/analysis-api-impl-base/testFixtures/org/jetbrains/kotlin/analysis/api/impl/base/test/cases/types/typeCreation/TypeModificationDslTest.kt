...
abstract class AbstractTypeModificationDslTest : AbstractTypeModificationDslTestBase("../analysis-api/testData/types/typeCreation/byDsl") {
    ...
    // region KaCapturedType modifications

    @Test
    @TestMetadata("capturedType/starProjectionMarkedNullable.kt")
    fun `capturedType starProjectionMarkedNullable +markNotNull`() = test<KaCapturedType> { type ->
        type.copy {
            isMarkedNullable = false
        }
    }
    ...
    fun `capturedType starProjection +markNullable`() = test<KaCapturedType> { type ->
        type.copy {
            isMarkedNullable = true
        }
    }
    ...
    @Test
    @TestMetadata("capturedType/outIntProjection.kt")
    fun `capturedType outIntProjection +markNullable`() = test<KaCapturedType> { type ->
        type.copy {
            isMarkedNullable = true
        }
    }
    ...
    @Test
    @TestMetadata("capturedType/starProjection.kt")
    fun `capturedType starProjection +addAnnotation`() = test<KaCapturedType> { type ->
        type.copy {
            annotation(ClassId.fromString("Anno"))
        }
    }
    ...
    // region KaDefinitelyNotNullType modifications

    @Test
    @TestMetadata("definitelyNotNullType/typeParameter.kt")
    fun `definitelyNotNullType typeParameter +addAnnotation`() = test<KaDefinitelyNotNullType> { type ->
        type.copy {
            annotation(ClassId.fromString("Anno"))
        }
    }
    ...
    // region KaFlexibleType modifications

    @Test
    @TestMetadata("flexibleType/intAndNullableInt.kt")
    fun `flexibleType intAndNullableInt +replaceUpperBound`() = test<KaFlexibleType> { type ->
        type.copy {
    ...
    @Test
    @TestMetadata("flexibleType/intAndNullableInt.kt")
    fun `flexibleType intAndNullableInt +replaceUpperBoundIncorrect`() = test<KaFlexibleType> { type ->
        type.copy {
            upperBound = classType(StandardClassIds.Nothing)
        }
    }

    @Test
    @TestMetadata("flexibleType/intAndNullableInt.kt")
    fun `flexibleType intAndNullableInt +replaceLowerBound`() = test<KaFlexibleType> { type ->
        type.copy {
            lowerBound = classType(StandardClassIds.Nothing)
        }
    }

    @Test
    @TestMetadata("flexibleType/intAndNullableInt.kt")
    fun `flexibleType intAndNullableInt +replaceLowerBoundIncorrect`() = test<KaFlexibleType> { type ->
        type.copy {
            lowerBound = classType(StandardClassIds.Any) { isMarkedNullable = true }
        }
    }
    ...
    @Test
    @TestMetadata("flexibleType/anyAndNullableAny.kt")
    fun `flexibleType anyAndNullableAny +addAnnotation`() = test<KaFlexibleType> { type ->
        type.copy {
            annotation(ClassId.fromString("Anno"))
        }
    }
    ...
    @Test
    @TestMetadata("flexibleType/flexibleTypeWithReplacedUpperBound.kt")
    fun `flexibleType flexibleTypeWithReplacedUpperBound +replaceUpperBound`() = test<KaFlexibleType> { type ->
        type.copy {
            upperBound = classType(StandardClassIds.Any) { isMarkedNullable = true }
        }
    }
...
abstract class AbstractTypeModificationDslTestBase(testDirPathString: String) : AbstractAnalysisApiExecutionTest(testDirPathString) {
    ...
    protected fun <T : KaType> test(block: KaSession.(T) -> Any?) {
        ...
        val actualText = copyAwareAnalyzeForTest(mainFile) {
            TypeCreatorDslTestRenderer.render(mainFile, environment.testServices, directoryName, testDataFileName) { value ->
