...
@Deprecated(
    "Use KtPsiMutatingService.getInstance().setCallableTypeReference(declaration, addAfter, typeRef) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().setCallableTypeReference(declaration, addAfter, typeRef)"),
)
...
@Deprecated(
    "Use KtPsiMutatingService.getInstance().setCallableReceiverTypeReference(this, typeRef) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().setCallableReceiverTypeReference(this, typeRef)"),
)
...
@Deprecated(
    "Use KtPsiMutatingService.getInstance().setFunctionTypeReceiverTypeReference(this, typeRef) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().setFunctionTypeReceiverTypeReference(this, typeRef)"),
)
