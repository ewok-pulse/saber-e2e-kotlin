...
class KtSecondaryConstructor : KtConstructor<KtSecondaryConstructor> {
    ...
    @Deprecated(
        "Use KtPsiMutatingService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis) instead",
        ReplaceWith("KtPsiMutatingService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis)"),
    )
    fun replaceImplicitDelegationCallWithExplicit(isThis: Boolean): KtConstructorDelegationCall =
        KtPsiMutatingService.getInstance().replaceImplicitDelegationCallWithExplicit(this, isThis)
}
