...
@Deprecated(
    "Use KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructor(this) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructor(this)"),
)
@OptIn(KtNonPublicApi::class)
fun KtClass.createPrimaryConstructorIfAbsent(): KtPrimaryConstructor =
    KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructor(this)

@Deprecated(
    "Use KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructorParameterList(this) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructorParameterList(this)"),
)
@OptIn(KtNonPublicApi::class)
fun KtClass.createPrimaryConstructorParameterListIfAbsent(): KtParameterList =
    KtPsiMutatingService.getInstance().getOrCreatePrimaryConstructorParameterList(this)
