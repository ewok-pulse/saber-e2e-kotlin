 ...
 * }</pre>
 *
 * <p>Returns {@code null} if resolution fails (e.g., when the type is unresolved or ambiguous).
 *
 * <p>This is a counterpart of {@code KtResolvable.resolveSymbol} focused specifically on user types.
 */
