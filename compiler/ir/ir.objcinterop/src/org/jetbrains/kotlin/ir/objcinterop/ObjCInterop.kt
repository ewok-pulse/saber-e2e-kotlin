...
fun IrClass.isObjCClass(): Boolean {
    ...
    fun inheritsObjCObject(clazz: IrClassSymbol): Boolean =
        // Note: Those are all the types defined inside Stdlib that directly or indirectly inherit from `ObjCClass`.
        clazz.hasEqualFqName(objCObjectFqName) || clazz.hasEqualFqName(objCClassFqName) || clazz.hasEqualFqName(objCProtocolFqName) ||
                clazz.hasEqualFqName(objCClassBaseFqName) || clazz.hasEqualFqName(objCClassBaseMetaFqName) ||
