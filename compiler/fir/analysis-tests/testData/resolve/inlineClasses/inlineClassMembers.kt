...
<!UNSUPPORTED_FEATURE("The feature \"value classes\" is experimental and should be enabled explicitly. This can be done by supplying the compiler argument '-XXLanguage:+ValueClasses', but note that no stability guarantees are provided.")!>value<!> class WithInner(val x: String) {
