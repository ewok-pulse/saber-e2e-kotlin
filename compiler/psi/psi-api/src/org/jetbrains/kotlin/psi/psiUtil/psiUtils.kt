...
@Deprecated(
    "Use KtPsiMutatingService.getInstance().replaceFileAnnotationList(file, annotationList) instead",
    ReplaceWith("KtPsiMutatingService.getInstance().replaceFileAnnotationList(file, annotationList)"),
)
@OptIn(KtNonPublicApi::class)
fun replaceFileAnnotationList(file: KtFile, annotationList: KtFileAnnotationList): KtFileAnnotationList {
    return KtPsiMutatingService.getInstance().replaceFileAnnotationList(file, annotationList)
}
