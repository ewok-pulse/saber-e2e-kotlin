...
/**
 * @param ignoreSuppression When `true`, diagnostics that would normally be suppressed by `@Suppress`
 * annotations are still reported. This is useful for detecting redundant suppression annotations.
 */
internal class LLFirDiagnosticReporter(
    private val ignoreSuppression: Boolean = false,
