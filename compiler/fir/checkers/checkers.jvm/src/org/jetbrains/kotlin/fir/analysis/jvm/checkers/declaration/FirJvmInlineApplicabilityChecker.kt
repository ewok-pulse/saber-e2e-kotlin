    ...
    override fun check(declaration: FirRegularClass) {
        ...
        if (annotation != null && !declaration.isValue) {
            ...
            if (!isExtendedValueClassSupportEnabled) {
                ...
                when {
                    // should not advise switching to Extended Value Classes, that would NOT help
                    ...
                    // should advise switching to Extended Value Classes, that would help
                    ...
                    primaryConstructorParameterCount == 1 || jvmInlineMultiFieldValueClassesEnabled -> {
                        reporter.reportOn(
                            ...
                            LanguageFeature.ValueClasses to context.languageVersionSettings
                        )
                    }

                    // The complexity appears because in this left case there are both reasons to advise switching to extended value classes:
                    // - Missing @JvmInline
