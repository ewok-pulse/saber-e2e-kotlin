 ...
 * `@LLFirInternals`. The skill `analysis-api-mark-internal-apis` is responsible for downgrading either suggestion to `internal` when the
 * declaration has no callers outside the module.
 *
