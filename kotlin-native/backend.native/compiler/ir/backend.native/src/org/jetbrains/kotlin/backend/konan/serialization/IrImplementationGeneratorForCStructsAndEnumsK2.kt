 ...
 * Unlike most other declarations from C/Objective-C, for which only linkable stubs are generated, C structs and C enums
 * are treated like "real" Kotlin classes and enums. They participate in lowerings and follow a similar compilation scheme.
 * This allows reusing e.g. [EnumClassLowering], [EnumConstructorsLowering] and other compiler phases.
 */
internal class IrImplementationGeneratorForCStructsAndEnumsK2(
        private val builtIns: IrBuiltIns,
        private val symbols: BackendNativeSymbols,
) {
    fun generateImplementationForCStruct(structClass: IrClass) {
    ...
    fun generateImplementationForCEnum(enumClass: IrClass) {
