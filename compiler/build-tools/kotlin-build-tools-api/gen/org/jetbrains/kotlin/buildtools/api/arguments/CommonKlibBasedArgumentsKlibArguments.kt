...
public interface CommonKlibBasedArgumentsKlibArguments : CommonKlibBasedArguments {
  ...
  public companion object {
    ...
    public val X_KLIB_DUPLICATED_UNIQUE_NAME_STRATEGY:
        CommonKlibBasedArgumentsKlibArgument<DuplicatedUniqueNameStrategy?> =
        CommonKlibBasedArgumentsKlibArgument("X_KLIB_DUPLICATED_UNIQUE_NAME_STRATEGY", KotlinReleaseVersion(2, 1, 0))
    ...
    @JvmField
    @ExperimentalCompilerArgument
    public val X_KLIB_ZIP_FILE_ACCESSOR_CACHE_LIMIT: CommonKlibBasedArgumentsKlibArgument<Int> =
        CommonKlibBasedArgumentsKlibArgument("X_KLIB_ZIP_FILE_ACCESSOR_CACHE_LIMIT", KotlinReleaseVersion(2, 3, 0))
