...
public abstract class KtNamedDeclarationStub<T extends KotlinStubWithFqName<?>> extends KtDeclarationStub<T> implements KtNamedDeclaration {
    ...
    /**
     * @deprecated Use {@code KtPsiMutatingService.getInstance().setNamedDeclarationStubName(this, name)} instead.
     */
    @Override
    @Deprecated
    public PsiElement setName(@NonNls @NotNull String name) throws IncorrectOperationException {
        return KtPsiMutatingService.getInstance().setNamedDeclarationStubName(this, name);
    }
