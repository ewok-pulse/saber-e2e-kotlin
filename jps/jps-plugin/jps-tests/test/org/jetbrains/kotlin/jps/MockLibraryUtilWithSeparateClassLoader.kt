...
import org.jetbrains.kotlin.test.kotlinPathsForDistDirectoryForTestsOrNull
...
/**
 * JPS tests are invoked from the IDEA environment, and so they need to invoke compiler
 * from the separate class loader to not mess up with the bundled kotlin compiler
 */
internal object MockLibraryUtilWithSeparateClassLoader {
